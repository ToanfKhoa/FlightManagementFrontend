...
import { PageResponse, ApiResponse } from "../types/commonType";

import type { Assignment, AssignmentRequest, GetAssignmentsParams } from "../types/assignmentType";

export const assignmentService = {
    getAll(params: GetAssignmentsParams = {}): Promise<ApiResponse<PageResponse<Assignment>>> {
        ...
        return axiosClient.get(`/assignments/all?${queryParams.toString()}`) as Promise<ApiResponse<PageResponse<Assignment>>>;
    },
